...
namespace MailSender.ConsoleTest.Reports
{
    public class Report
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "00186070", RsidRunAdditionDefault = "001D7663", ParagraphId = "64C1C026", TextId = "411E1072" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "001D7663", RsidRunAdditionDefault = "001D7663", ParagraphId = "3969B956", TextId = "27F7DC81" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "001D7663", RsidParagraphAddition = "001D7663", RsidRunAdditionDefault = "001D7663", ParagraphId = "6AD3068B", TextId = "7DDA79CF" };
            ...
            Run run2 = new Run() { RsidRunProperties = "001D7663" };
            ...
            Shading shading1 = new Shading() { Val = ShadingPatternValues.Clear, Color = "auto", Fill = "F7CAAC", ThemeFill = ThemeColorValues.Accent2, ThemeFillTint = "66" };
            ...
            runProperties2.Append(shading1);
            runProperties2.Append(languages5);
            Text text2 = new Text();
            text2.Text = TimeValue.ToString("R");
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "001D7663", RsidR = "001D7663" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "157447BB" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{A258D895-B6F4-4DD0-BF73-31EE4D86F59F}" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2019-10-12T14:13:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2019-10-12T14:14:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Павел Шмачилин";
        }

        #region Binary Data
        private string thumbnailPart1Data = "";
